package com.segware.upvote.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("API de Post")
                .description("API para cadastro, consulta e votação de posts")
                .version("1.0.0")
                .contact(new Contact("Segware Upvote", "http://localhost:4200/", "lucandrodrigues@gmail.com"))
                .build();
    }
